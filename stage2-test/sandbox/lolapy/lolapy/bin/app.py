...
# Imports routes
from lolapy.blueprints import algorithm_blueprint, scenario_blueprint, dataset_blueprint, server_blueprint
...
flask_app.register_blueprint(server_blueprint)
...
if __name__ == "__main__":
    ...
    flask_app.run(host=app_settings.lolapy_host_ip, debug=None, port=app_port)
